...
#pruned_model = AutoModelForSequenceClassification.from_pretrained("../prune-40/pruned_bert_agnews_structured-40-1", local_files_only=True)
pruned_model = torch.load("../shrunk_bert_state-prune-40.pt")
...
summary_df.to_csv("./metrics/inference_summary-pruned-40.csv", index=False)
