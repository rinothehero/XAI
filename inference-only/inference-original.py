...
origianl_model = AutoModelForSequenceClassification.from_pretrained(model_path, local_files_only=True)
origianl_model.to('cuda:1').eval()
...
summary_df.to_csv("./metrics/inference_summary-original.csv", index=False)
