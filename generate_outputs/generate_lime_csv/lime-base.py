...
# 2. Load pruned model
pruned_model = AutoModelForSequenceClassification.from_pretrained(model_path, local_files_only=True)
...
output_df.to_csv("lime_explanation-base.csv", index=False)
