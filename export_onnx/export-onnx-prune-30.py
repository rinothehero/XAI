...
# 🔁 MAIN: shrink + export
model_path = "models/pruned/bert_agnews_30pct_v1" # Placeholder, ensure this model exists or adjust path
...
torch.onnx.export(
    ...
    "models/onnx/shrunk_bert-prune-30.onnx",
...
print("✅ ONNX export 완료 → models/onnx/shrunk_bert-prune-30.onnx")
