...
quantized_model = torch.load("../quantized-bert/quantized16_pruned_dynamic-3.pt")
quantized_model.to('cuda').eval()
...
def predict_proba(texts):
    ...
    inputs = {
        k: (v.to("cuda") if k in keep_long else v.half().to("cuda"))
...
output_df.to_csv("lime_explanation-q16_p-3.csv", index=False)
