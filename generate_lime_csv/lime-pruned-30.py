...
# 2. Load pruned model
pruned_model = AutoModelForSequenceClassification.from_pretrained("../pruned_bert_agnews_structured-30-7", local_files_only=True)
...
output_df.to_csv("lime_explanation-pruned-30.csv", index=False)
