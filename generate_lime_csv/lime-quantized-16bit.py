...
quantized_model = torch.load("./quantized_bert_agnews_16bit.pt")
quantized_model = quantized_model.half().to("cuda")  # GPU로 이동
...
output_df.to_csv("lime_explanation-16bit.csv", index=False)
