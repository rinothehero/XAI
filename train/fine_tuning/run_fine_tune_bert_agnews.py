...
args = TrainingArguments(
    output_dir="models/fine_tuned/bert_agnews",
...
tokenizer.save_pretrained("models/fine_tuned/bert_agnews")
print("Fine-tuning complete. Model saved to 'models/fine_tuned/bert_agnews'")