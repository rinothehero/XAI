...
save_path  = "../pruned_bert_agnews_structured-20-7"
...
for _, module, weight_name in to_prune:
    prune.ln_structured(module, name=weight_name, amount=0.2, n=1, dim=0)
...
MAX_STEPS = int(len(train_loader) * 0.3)  # 1 epoch
step_count = 0
